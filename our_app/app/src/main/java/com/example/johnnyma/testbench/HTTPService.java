...
public class HTTPService extends Service {
    ...
    // DELETE: should remove a course from user's course list
    public void deleteUserCourse(String userID, String courseID)throws IOException {
        Request request = new Request.Builder().url(" //TODO ").build();
        Response response = client.newCall(request).execute();
        if (!response.isSuccessful()) {
            throw new IOException("Unexpected code " + response);
    ...
    // PUT: should add like to question based on question id
    public void likeQuestion(String questionID) throws IOException {
        Request request = new Request.Builder().url(" //TODO ").build();
        Response response = client.newCall(request).execute();
        if (!response.isSuccessful()) {
            throw new IOException("Unexpected code " + response);
    ...
    // PUT: should add dislike to question based on question id
    public void dislikeQuestion(String questionID) throws IOException {
        Request request = new Request.Builder().url(" //TODO ").build();
        Response response = client.newCall(request).execute();
        if (!response.isSuccessful()) {
            throw new IOException("Unexpected code " + response);
